...
import com.mycompany.deepfaked.Video;
...
public class MainScreenController implements Initializable {
        ...
        webEngine.getLoadWorker().stateProperty().addListener((observable, oldState, newState) -> {
            if (newState == State.SUCCEEDED) {
                ...
                if (document != null) {
                    ...
                    mediaplayer = new MediaPlayer(new Media(deepfake.getLocation()));
                    mediaplayer.play();
                    ...
                    webviewTiktok.setOnMouseClicked((event) -> {
                        FXMLLoader loader = new FXMLLoader(MediaFactory.class.getResource(PropertiesHolder.getInstance().getProperty("defaultMap") + "/view/video.fxml"));
                        Video videoController = new Video(deepfake.getLocation());
                        ...
                        try {
                            ...
                            videoStage.setOnHidden(e -> videoController.stop());
                            videoStage.show();
    ...
    protected void sendMessage() {
        ...
        try {
            ...
            txtMessage.setText("");
            txtMessage.requestFocus();
            Text answer = new Text(ChatGPT.chatGPT(message.getText().trim()));
            /*"In de eerste verzen van hoofdstuk 3 van het Johannesevangelie worden we met een centraal begrip uit het christendom geconfronteerd. Een begrip dat bij Nikodemus, een Farizeeër en een Joodse leider, niet erg bekend was: \n\n"
